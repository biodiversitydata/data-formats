...
::: {.small}
_Suggested packages:_ `DBI` & `RMariaDB`
...
## Connect to SQLite database ----
con <- DBI::dbConnect(RMariaDB::MariaDB(), dbname = ...)
```
:::
:::
...
{{< fa circle-right >}} &nbsp;Use the function [`readr::guess_encoding()`](https://readr.tidyverse.org/reference/encoding.html) to find the good encoding (UTF-8, Latin-1, CP1252, etc.)
